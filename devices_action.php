...
for ($i=1; $i<=$_POST['amount'];$i++) {	  
  $sql= sprintf("INSERT INTO devices (`description`, `hostname`, `owner_id`, `user_id`, `device_type`,`konts`,`inv_id`, `invoice_id`,`status`, `id`) VALUES (%s,%s,%s, %s, %s, %s, %s, %s, %s, %s)",
...
`device_type`=".GetSQLValueString($_POST['device_type'], "int").",
